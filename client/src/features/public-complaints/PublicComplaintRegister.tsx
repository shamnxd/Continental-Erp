...
import { CheckCircle2, Loader2, ArrowLeft, ArrowRight, FileText } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        {/* Logo + title matching login style */}
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-500">Service Register Portal</p>
        </div>

        {/* Step Indicator */}
        <div className="mb-6 flex justify-between items-center text-xs font-semibold text-slate-400">
