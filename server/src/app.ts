...
import { costingRouter } from "./routes/costing.routes";
import { copperPipeRateRouter } from "./routes/copperPipeRate.routes";
...
app.use("/api/v1/costings", costingRouter);
app.use("/api/v1/copper-pipe-rates", copperPipeRateRouter);
